...
Περιβάλλον PHP 8.5.5 & MYSQL 8.0.32, σιγουρευτείτε πως τα extensions pdο_mysql, mysqli είναι ενεργοποιημένα στο php.ini
...
O κανονικός τρόπος μεταφοράς των .env είναι άλλος πιο ασφαλής και όχι απλώς push στο github
...
Εύκολη μετατροπή σε Docker αν χρειαστεί
